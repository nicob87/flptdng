...
class CustomKraken(ccxtpro.kraken):
    ...
    async def save_orderbook_message(self, raw_message, processed_orderbook):
        ...
        print("===== 0 save_orderbook_message called")
        if not self.db_pool:
